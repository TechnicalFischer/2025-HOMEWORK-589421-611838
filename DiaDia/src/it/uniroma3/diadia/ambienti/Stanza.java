...
//	public boolean removeAttrezzo(Attrezzo wanted) {
    public boolean removeAttrezzo(Attrezzo attrezzo) {
		int i,j;
		if(this.numeroAttrezzi==0||attrezzo==null)return false;
		for(i=0;i<(this.numeroAttrezzi-1);i++) {
		...
		}if(this.attrezzi[this.numeroAttrezzi-1].getNome().equals(attrezzo.getNome())) {
			this.numeroAttrezzi--;
			return true;
		}
		return false;
